...
const Hero = () => {
  return (
    ...
    <p className={`${styles.heroSubText} mt-1 text-black-100`}> I develop web applications and user interfaces</p>
    </div>
    </div>
    <ComputerCanvas/>
    <div className='absolute bottom-0.5 w-full flex justify-center items-center'>
     <a href="#about">
